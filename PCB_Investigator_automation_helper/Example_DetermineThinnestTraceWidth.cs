...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to determine the thinnest trace width of specified nets by using the PCB-Investigator API.
        /// </summary>
        private static string Example_DetermineThinnestTraceWidth(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, List<string> netNames)
        {
