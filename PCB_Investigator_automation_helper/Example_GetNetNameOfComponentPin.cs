...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve the net name of a specific pin of a component by using the PCB-Investigator API.
        /// </summary>
        private static string Example_GetNetNameOfComponentPin(IPCBIWindow pcbi, IStep step, string componentName, string pinNumber)
        {
