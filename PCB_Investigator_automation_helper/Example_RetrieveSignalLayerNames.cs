...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve all signal layer names from a loaded job by using the PCB-Investigator API.
        /// </summary>
        private static string Example_RetrieveSignalLayerNames(IPCBIWindow pcbi, IStep step)
        {
