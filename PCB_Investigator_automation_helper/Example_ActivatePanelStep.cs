...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to activate the panel step in a PCB job by using the PCB-Investigator API.
        /// </summary>
        private static string Example_ActivatePanelStep(IPCBIWindow pcbi, IStep step)
        {
        ...
        /// Example method to activate the panel step in a PCB job by using the PCB-Investigator API.
        /// </summary>
        private static string Example_ActivatePanelStep(IPCBIWindow pcbi, IStep currentStep)
        {
            // Check if a job is loaded
            if (!pcbi.JobIsLoaded) return "No job is loaded.";
            ...
            {
                return "The current step " + currentStep.Name + " is already the panel step.";
            }
            else
            {
                // Iterate through all steps to find the panel step
