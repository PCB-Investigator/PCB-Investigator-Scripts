...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve panel building tasks from the design history by using the PCB-Investigator API.
        /// </summary>
        private static async Task<string> Example_RetrievePanelBuildingTasks(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
