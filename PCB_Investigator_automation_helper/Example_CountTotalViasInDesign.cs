...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to count the total number of vias in the design by using the PCB-Investigator API.
        /// </summary>
        private static string Example_CountTotalViasInDesign(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
