...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to count SMT and THT components in a given step by using the PCB-Investigator API.
        /// </summary>
        private static string Example_CountComponentsByMountType(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
