...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to find a specific pin's net name on a component by using the PCB-Investigator API.
        /// </summary>
        private static string Example_FindPinNetName(IPCBIWindow pcbi, IStep step, string componentName, string pinNumber)
        {
