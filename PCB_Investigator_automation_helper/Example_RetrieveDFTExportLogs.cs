...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve and log DFT export entries from the design history by using the PCB-Investigator API.
        /// </summary>
        private static async Task<string> Example_RetrieveDFTExportLogs(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string taskCategory, string taskName)
        {
            ...
            // Return the DFT export logs or a message if no logs were found
            if (sb.Length > 0)
            {
        ...
        /// <summary>
        /// Example method to retrieve and display DFT export logs by using the PCB-Investigator API.
        /// </summary>
        private static async Task<string> Example_RetrieveDFTExportLogs(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string taskValue)
        {
            // Check if a job is loaded
            if (!pcbi.JobIsLoaded) return "No job is loaded.";
