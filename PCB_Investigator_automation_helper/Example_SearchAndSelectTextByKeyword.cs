...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to search and select text objects in a PCB design by using the PCB-Investigator API
        /// </summary>
        private static string Example_SearchAndSelectTextByKeyword(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string searchKeyword)
        {
