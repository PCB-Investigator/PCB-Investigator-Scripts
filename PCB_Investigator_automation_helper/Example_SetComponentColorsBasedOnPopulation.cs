...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to set component colors based on population status by using the PCB-Investigator API.
        /// </summary>
        private static string Example_SetComponentColorsBasedOnPopulation(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
