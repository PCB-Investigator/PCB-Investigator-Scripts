...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve and log DFT export history by using the PCB-Investigator API.
        /// </summary>
        private static async Task<string> Example_RetrieveDFTExportHistory(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string taskValue)
        {
