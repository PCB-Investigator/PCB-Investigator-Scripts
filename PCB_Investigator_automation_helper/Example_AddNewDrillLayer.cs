...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to add a new drill layer to the design by using the PCB-Investigator API
        /// </summary>
        private static string Example_AddNewDrillLayer(IPCBIWindow pcbi, IStep step, string newLayerName)
        {
