...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to mark components with vias underneath them by using the PCB-Investigator API.
        /// </summary>
        private static string Example_MarkComponentsWithViasUnderneath(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
