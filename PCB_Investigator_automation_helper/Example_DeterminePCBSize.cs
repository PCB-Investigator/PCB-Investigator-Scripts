...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to determine the size of the current PCB in the loaded step by using the PCB-Investigator API.
        /// </summary>
        private static string Example_DeterminePCBSize(IPCBIWindow pcbi, IStep step, bool showMetricUnit)
        {
