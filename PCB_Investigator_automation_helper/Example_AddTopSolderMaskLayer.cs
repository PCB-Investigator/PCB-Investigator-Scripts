...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to add a new top solder mask layer to the design by using the PCB-Investigator API
        /// </summary>
        private static string Example_AddTopSolderMaskLayer(IPCBIWindow pcbi, IStep step, string newLayerName)
        {
            ...
            if (newLayer != null)
            {
                ...
                // Move the solder mask layer in front of the top signal layer
                ...
                {
                    if (!added && string.Compare(layer, topSignalLayer, true) == 0)
                    {
                ...
                return "The new top solder mask layer '" + newLayerName + "' is added to the design.";
            }
            else
            {
                return "Failed to create the new top solder mask layer '" + newLayerName + "'.";
            }
        }
