...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve signal layers used by a specified net in a PCB design by using the PCB-Investigator API.
        /// </summary>
        private static string Example_GetSignalLayersForNet(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string netName)
        {
