...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve the total number of components connected to a specified net by using the PCB-Investigator API.
        /// </summary>
        private static string Example_GetConnectedComponentsCount(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string netName)
        {
