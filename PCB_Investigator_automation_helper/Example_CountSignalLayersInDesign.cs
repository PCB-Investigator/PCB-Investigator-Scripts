...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to count the total number of signal layers in the design by using the PCB-Investigator API.
        /// </summary>
        private static string Example_CountSignalLayersInDesign(IPCBIWindow pcbi, IStep step)
        {
