...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to select all THT components in the current step by using the PCB-Investigator API.
        /// </summary>
        private static string Example_SelectTHTComponents(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
            ...
            if (count > 0)
            {
                ...
                return "All " + count + " THT components have been selected in the current step.";
            }
            else
            {
