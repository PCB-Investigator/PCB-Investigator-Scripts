...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to open the datasheet link for a selected component by using the PCB-Investigator API
        /// </summary>
        private static string Example_OpenComponentDatasheet(IPCBIWindow pcbi, IStep step)
        {
