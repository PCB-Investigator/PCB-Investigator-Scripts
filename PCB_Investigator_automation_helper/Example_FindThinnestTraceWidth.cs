...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to find the thinnest trace width on the top layer in the current design by using the PCB-Investigator API.
        /// </summary>
        private static string Example_FindThinnestTraceWidth(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
        ...
        /// <summary>
        /// Example method to find the thinnest trace width of specified nets by using the PCB-Investigator API.
        /// </summary>
        private static string Example_FindThinnestTraceWidth(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, List<string> netNames)
        {
            // Check if a job is loaded
            if (!pcbi.JobIsLoaded) return "No job is loaded.";
            // Get the unit the user wants to see in the UI (metric or imperial)
