...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to find and select text objects in a PCB design by using the PCB-Investigator API
        /// </summary>
        private static string Example_FindAndSelectTextObjects(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string searchKeyword)
        {
