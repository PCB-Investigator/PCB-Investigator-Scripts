...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to add a new bottom solder paste layer to the design by using the PCB-Investigator API
        /// </summary>
        private static string Example_AddBottomSolderPasteLayer(IPCBIWindow pcbi, IStep step, string newLayerName)
        {
            ...
            if (newLayer != null)
            {
                ...
                // Move the solder paste layer in front of the bottom component layer
                ...
                return "The new bottom solder paste layer '" + newLayerName + "' is added to the design.";
            }
            else
            {
                return "Failed to create the new bottom solder paste layer '" + newLayerName + "'.";
            }
        }
