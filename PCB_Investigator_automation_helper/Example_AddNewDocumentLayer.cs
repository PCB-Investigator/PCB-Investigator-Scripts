...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to add a new document layer to the design by using the PCB-Investigator API.
        /// </summary>
        private static string Example_AddNewDocumentLayer(IPCBIWindow pcbi, IStep step, string newLayerName)
        {
