...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve the polarity of a specified layer by using the PCB-Investigator API
        /// </summary>
        private static string Example_GetLayerPolarity(IPCBIWindow pcbi, IStep step, string layerName)
        {
