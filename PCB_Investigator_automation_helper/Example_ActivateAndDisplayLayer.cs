...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to activate and display a specified layer by using the PCB-Investigator API.
        /// </summary>
        private static string Example_ActivateAndDisplayLayer(IPCBIWindow pcbi, IStep step, string layerName)
        {
