...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to identify and select components with vias underneath them by using the PCB-Investigator API.
        /// </summary>
        private static string Example_SelectComponentsWithViasUnderneath(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken)
        {
