...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to calculate the distance between two components by using the PCB-Investigator API
        /// </summary>
        private static string Example_CalculateDistanceBetweenComponents(IPCBIWindow pcbi, IStep step, string componentRef1, string componentRef2)
        {
            ...
            {
                // Check if the components are on the same side of the board
                if (cmp1.PlacedTop != cmp2.PlacedTop)
                {
                    return $"The components {componentRef1} and {componentRef2} are not on the same side of the board.";
                }
                ...
                return $"The distance between component {componentRef1} and component {componentRef2} is " +
