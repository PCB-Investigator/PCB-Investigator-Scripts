...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to retrieve connected components for a specified net by using the PCB-Investigator API.
        /// </summary>
        private static string Example_RetrieveConnectedComponentsForNet(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, string netName)
        {
