...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to find the net name of a specific pin on a component by using the PCB-Investigator API.
        /// </summary>
        private static string Example_FindNetNameOfComponentPin(IPCBIWindow pcbi, IStep step, string componentName, string pinNumber)
        {
