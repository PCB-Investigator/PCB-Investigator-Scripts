...
/// </summary>
    ...
    {
        /// <summary>
        /// Example method to select components taller than a specified height in the current step by using the PCB-Investigator API.
        /// </summary>
        private static string Example_SelectComponentsTallerThanHeight(IPCBIWindow pcbi, IStep step, CancellationToken? cancelToken, double heightInMM)
        {
            ...
            // Iterate through all components to find those taller than the specified height
